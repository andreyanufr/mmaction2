...
ann_file_train = f'data/hmdb51/SC_hmdb51_{num_classes}cls_{num_samples}_samples/train_list_rawframes.txt'
ann_file_val = f'data/hmdb51/SC_hmdb51_{num_classes}10cls_{num_samples}_samples/val_list_rawframes.txt'
ann_file_test = f'data/hmdb51/SC_hmdb51_{num_classes}cls_{num_samples}_samples/test_list_rawframes.txt'
img_norm_cfg = dict(
...
# runtime settings
work_dir = './work_dirs/EVL_HMDB51_ViT-B-16_SC'
