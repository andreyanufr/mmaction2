...
bash tools/dist_train.sh configs/recognition/evl/evl_ucf101_rgb.py 8 --validate --work-dir work_dirs/EVL_UCF101_ViT-L-14_split1_V100_8gpu --seed 0 --deterministic
...
bash tools/dist_train.sh configs/recognition/movinet_SC_eperiment/movinets_A0_base_UCF101.py 8 --validate --work-dir work_dirs/MoViNet_A0_base_UCF101_V100_8gpu --seed 0 --deterministic
